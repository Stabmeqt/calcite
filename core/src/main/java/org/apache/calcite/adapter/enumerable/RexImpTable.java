...
import static org.apache.calcite.sql.fun.SqlStdOperatorTable.TO_TIMESTAMP;
...
public class RexImpTable {
  ...
  RexImpTable() {
    ...
    defineMethod(TO_TIMESTAMP, BuiltInMethod.REGEX_STRING_TO_TIMESTAMP.method, NullPolicy.ANY);
